    ...
    <div class='flex flex-center'>
        <el-row class='errPage-container'>
            <el-col :span='12'>
                ...
                页面
                <h2 class='font-semibold text-2xl my-6'>You don't have permission to go to this page</h2>
                <h6 class='font-semibold text-xs my-6'>If you are dissatisfied, please contact your leader</h6>
