<template>
    ...
    <ul ref='rightMenuEl' class='border border-gray-200 absolute w-24 leading-none bg-white shadow-md rounded-lg py-0.5 z-10' :style='menuPos'>
        <li class='px-4 py-2 cursor-pointer hover:bg-gray-200' @click='refresh'>Refresh</li>
        <li class='px-4 py-2 cursor-pointer hover:bg-gray-200' @click='closeOther'>Close other</li>
        <li class='px-4 py-2 cursor-pointer hover:bg-gray-200' @click='removeAllTagNav'>Close all</li>
    </ul>
</template>
