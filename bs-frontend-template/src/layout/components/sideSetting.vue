<template>
    ...
    <el-drawer v-model='drawer' title='System layout settings' size='280px'>
        <div class='pt-4'>
            <p class='py-2'>Side theme settings</p>
            <el-row :gutter='20'>
            ...
            <p class='py-2'>Navigation mode</p>
            <el-row :gutter='20'>
                <el-col :span='8'>
