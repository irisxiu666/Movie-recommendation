        ...
        if form.is_valid():
            ...
            if result:
                ...
                if user.password == password:
                    ...
                    return render(
                        request, "login.html", {"form": form, "message": "wrong password"}
                    )
            else:
                return render(
                    request, "login.html", {"form": form, "message": "account doesn't exist"}
                )
    else:
        form = Login()
...
def personal(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(
                request, "personal.html", {"message": "update successfully!", "form": form, 'title': 'My information', 'user': user}
            )
        else:
            return render(
                request, "personal.html", {"message": "update failed", "form": form, 'title': 'My information', 'user': user}
            )
    form = Edit(instance=user)
    return render(request, "personal.html", {"user": user, 'form': form, 'title': 'My information'})
